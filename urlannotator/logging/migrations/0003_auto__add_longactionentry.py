...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LongActionEntry'
        db.create_table('logging_longactionentry', (
        ...
        db.send_create_signal('logging', ['LongActionEntry'])


    def backwards(self, orm):
        # Deleting model 'LongActionEntry'
        db.delete_table('logging_longactionentry')
