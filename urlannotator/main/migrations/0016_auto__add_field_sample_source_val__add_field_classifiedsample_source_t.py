...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.source_val'
        db.add_column('main_sample', 'source_val',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ClassifiedSample.source_type'
        db.add_column('main_classifiedsample', 'source_type',
                      self.gf('django.db.models.fields.CharField')(default='owner', max_length=100),
                      keep_default=False)

        # Adding field 'ClassifiedSample.source_val'
        db.add_column('main_classifiedsample', 'source_val',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.source_val'
        db.delete_column('main_sample', 'source_val')

        # Deleting field 'ClassifiedSample.source_type'
        db.delete_column('main_classifiedsample', 'source_type')

        # Deleting field 'ClassifiedSample.source_val'
        db.delete_column('main_classifiedsample', 'source_val')
