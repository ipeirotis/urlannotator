...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FillSample.url'
        db.alter_column('main_fillsample', 'url', self.gf('django.db.models.fields.URLField')(max_length=500, primary_key=True))

        # Changing field 'Sample.screenshot'
        db.alter_column('main_sample', 'screenshot', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'Sample.url'
        db.alter_column('main_sample', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'FillSample.url'
        db.alter_column('main_fillsample', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, primary_key=True))

        # Changing field 'Sample.screenshot'
        db.alter_column('main_sample', 'screenshot', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Sample.url'
        db.alter_column('main_sample', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
