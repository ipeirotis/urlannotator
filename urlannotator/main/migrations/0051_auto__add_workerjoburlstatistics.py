...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkerJobURLStatistics'
        db.create_table('main_workerjoburlstatistics', (
        ...
        db.send_create_signal('main', ['WorkerJobURLStatistics'])


    def backwards(self, orm):
        # Deleting model 'WorkerJobURLStatistics'
        db.delete_table('main_workerjoburlstatistics')
