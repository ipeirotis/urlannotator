...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'URLStatistics'
        db.create_table('main_urlstatistics', (
        ...
        db.send_create_signal('main', ['URLStatistics'])

        # Adding model 'ProgressStatistics'
        db.create_table('main_progressstatistics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('main', ['ProgressStatistics'])

        # Adding model 'SpentStatistics'
        db.create_table('main_spentstatistics', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('main', ['SpentStatistics'])


    def backwards(self, orm):
        # Deleting model 'URLStatistics'
        db.delete_table('main_urlstatistics')

        # Deleting model 'ProgressStatistics'
        db.delete_table('main_progressstatistics')

        # Deleting model 'SpentStatistics'
        db.delete_table('main_spentstatistics')
