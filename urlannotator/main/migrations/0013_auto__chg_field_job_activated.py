...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.activated'
        db.alter_column('main_job', 'activated', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Job.activated'
        db.alter_column('main_job', 'activated', self.gf('django.db.models.fields.DateTimeField')())
