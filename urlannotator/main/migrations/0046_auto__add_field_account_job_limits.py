...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.job_limits'
        db.add_column('main_account', 'job_limits',
    ...
    def backwards(self, orm):
        # Deleting field 'Account.job_limits'
        db.delete_column('main_account', 'job_limits')
