...
class Migration(DataMigration):
    ...
    BTM_NEW_ACTIVE = 'active'
    BTM_NEW_NOT_ACTIVE = 'not_active'

    def forwards(self, orm):
        "Write your forwards methods here."
        for job in orm['main.Job'].objects.all():
            if job.btm_active:
                job.btm_status = self.BTM_NEW_ACTIVE
            else:
                job.btm_status = self.BTM_NEW_NOT_ACTIVE
            job.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        for job in orm['main.Job'].objects.all():
            job.btm_active = job.btm_status == self.BTM_NEW_ACTIVE
            job.save()
