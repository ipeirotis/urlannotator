...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FillSample.text'
        db.delete_column('main_fillsample', 'text')

        # Deleting field 'FillSample.screenshot'
        db.delete_column('main_fillsample', 'screenshot')


    def backwards(self, orm):
        # Adding field 'FillSample.text'
        db.add_column('main_fillsample', 'text',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)

        # Adding field 'FillSample.screenshot'
        db.add_column('main_fillsample', 'screenshot',
