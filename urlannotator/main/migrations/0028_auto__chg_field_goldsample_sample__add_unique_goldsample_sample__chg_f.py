...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoldSample.sample'
        db.alter_column('main_goldsample', 'sample_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Sample'], unique=True))
        # Adding unique constraint on 'GoldSample', fields ['sample']
        db.create_unique('main_goldsample', ['sample_id'])


        # Changing field 'Account.worker_entry'
        db.alter_column('main_account', 'worker_entry_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Worker'], unique=True, null=True))
        # Adding unique constraint on 'Account', fields ['worker_entry']
        db.create_unique('main_account', ['worker_entry_id'])


        # Changing field 'Account.user'
        db.alter_column('main_account', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True))
        # Adding unique constraint on 'Account', fields ['user']
        db.create_unique('main_account', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['user']
        db.delete_unique('main_account', ['user_id'])

        # Removing unique constraint on 'Account', fields ['worker_entry']
        db.delete_unique('main_account', ['worker_entry_id'])

        # Removing unique constraint on 'GoldSample', fields ['sample']
        db.delete_unique('main_goldsample', ['sample_id'])


        # Changing field 'GoldSample.sample'
        db.alter_column('main_goldsample', 'sample_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Sample']))

        # Changing field 'Account.worker_entry'
        db.alter_column('main_account', 'worker_entry_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Worker'], null=True))

        # Changing field 'Account.user'
        db.alter_column('main_account', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
