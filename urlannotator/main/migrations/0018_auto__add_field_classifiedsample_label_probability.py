...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassifiedSample.label_probability'
        db.add_column('main_classifiedsample', 'label_probability',
                      self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassifiedSample.label_probability'
        db.delete_column('main_classifiedsample', 'label_probability')
