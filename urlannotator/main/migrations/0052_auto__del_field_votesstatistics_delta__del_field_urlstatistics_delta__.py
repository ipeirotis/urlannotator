...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VotesStatistics.delta'
        db.delete_column('main_votesstatistics', 'delta')

        # Deleting field 'URLStatistics.delta'
        db.delete_column('main_urlstatistics', 'delta')

        # Deleting field 'ProgressStatistics.delta'
        db.delete_column('main_progressstatistics', 'delta')

        # Deleting field 'SpentStatistics.delta'
        db.delete_column('main_spentstatistics', 'delta')

        # Deleting field 'LinksStatistics.delta'
        db.delete_column('main_linksstatistics', 'delta')


    def backwards(self, orm):
        # Adding field 'VotesStatistics.delta'
        db.add_column('main_votesstatistics', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'URLStatistics.delta'
        db.add_column('main_urlstatistics', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'ProgressStatistics.delta'
        db.add_column('main_progressstatistics', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'SpentStatistics.delta'
        db.add_column('main_spentstatistics', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'LinksStatistics.delta'
        db.add_column('main_linksstatistics', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)
    ...
    models = {
        ...
        'main.account': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job_limits': ('tenclouds.django.jsonfield.fields.JSONField', ['{}'], {'blank': 'True'}),
        ...
        'main.job': {
            ...
            'btm_description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'btm_points_to_cash': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'btm_status': ('django.db.models.fields.CharField', [], {'default': "'not_active'", 'max_length': '50'}),
            'btm_title': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '250'}),
        ...
        'main.workerjobassociation': {
            ...
            'urls_gathered': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'votes_gathered': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'worked_hours': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'worker': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Worker']"})
        },
        'main.workerjoburlstatistics': {
            'Meta': {'object_name': 'WorkerJobURLStatistics'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']"}),
            'value': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
