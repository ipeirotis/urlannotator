...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkerJobAssociation.votes_gathered'
        db.add_column('main_workerjobassociation', 'votes_gathered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'WorkerJobAssociation.urls_gathered'
        db.add_column('main_workerjobassociation', 'urls_gathered',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Worker.name'
        db.add_column('main_worker', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkerJobAssociation.votes_gathered'
        db.delete_column('main_workerjobassociation', 'votes_gathered')

        # Deleting field 'WorkerJobAssociation.urls_gathered'
        db.delete_column('main_workerjobassociation', 'urls_gathered')

        # Deleting field 'Worker.name'
        db.delete_column('main_worker', 'name')
