...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinksStatistics'
        db.create_table('main_linksstatistics', (
        ...
        db.send_create_signal('main', ['LinksStatistics'])


        # Changing field 'WorkerJobAssociation.worked_hours'
        db.alter_column('main_workerjobassociation', 'worked_hours', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))

    def backwards(self, orm):
        # Deleting model 'LinksStatistics'
        db.delete_table('main_linksstatistics')


        # Changing field 'WorkerJobAssociation.worked_hours'
        db.alter_column('main_workerjobassociation', 'worked_hours', self.gf('django.db.models.fields.PositiveIntegerField')())
