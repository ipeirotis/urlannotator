...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.gold_left'
        db.add_column('main_job', 'gold_left',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.gold_left'
        db.delete_column('main_job', 'gold_left')
    ...
    models = {
        ...
        'main.job': {
            ...
            'gold_left': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
