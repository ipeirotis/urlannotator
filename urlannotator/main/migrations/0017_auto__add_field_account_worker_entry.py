...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.worker_entry'
        db.add_column('main_account', 'worker_entry',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Worker'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.worker_entry'
        db.delete_column('main_account', 'worker_entry_id')
