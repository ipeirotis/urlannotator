...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VotesStatistics'
        db.create_table('main_votesstatistics', (
        ...
        db.send_create_signal('main', ['VotesStatistics'])


    def backwards(self, orm):
        # Deleting model 'VotesStatistics'
        db.delete_table('main_votesstatistics')
