...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.quality_algorithm'
        db.alter_column('main_job', 'quality_algorithm', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Job.votes_storage'
        db.alter_column('main_job', 'votes_storage', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Job.quality_algorithm'
        db.alter_column('main_job', 'quality_algorithm', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'Job.votes_storage'
        db.alter_column('main_job', 'votes_storage', self.gf('django.db.models.fields.CharField')(max_length=25))
