...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.initialization_status'
        db.add_column('main_job', 'initialization_status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.initialization_status'
        db.delete_column('main_job', 'initialization_status')
