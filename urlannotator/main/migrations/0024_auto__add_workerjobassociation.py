...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WorkerJobAssociation'
        db.create_table('main_workerjobassociation', (
            ...
            ('worked_hours', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
        ))
        db.send_create_signal('main', ['WorkerJobAssociation'])


    def backwards(self, orm):
        # Deleting model 'WorkerJobAssociation'
        db.delete_table('main_workerjobassociation')
