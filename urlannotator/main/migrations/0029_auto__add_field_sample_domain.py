...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.domain'
        db.add_column('main_sample', 'domain',
                      self.gf('django.db.models.fields.CharField')(default='example.foo.bar', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.domain'
        db.delete_column('main_sample', 'domain')
