...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sample.label'
        db.delete_column('main_sample', 'label')

        # Adding unique constraint on 'Sample', fields ['url', 'job']
        db.create_unique('main_sample', ['url', 'job_id'])

        # Adding field 'ClassifiedSample.label'
        db.add_column('main_classifiedsample', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Sample', fields ['url', 'job']
        db.delete_unique('main_sample', ['url', 'job_id'])

        # Adding field 'Sample.label'
        db.add_column('main_sample', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)

        # Deleting field 'ClassifiedSample.label'
        db.delete_column('main_classifiedsample', 'label')
