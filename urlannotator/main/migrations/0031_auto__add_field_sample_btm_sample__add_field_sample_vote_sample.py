...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sample.btm_sample'
        db.add_column('main_sample', 'btm_sample',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Sample.vote_sample'
        db.add_column('main_sample', 'vote_sample',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sample.btm_sample'
        db.delete_column('main_sample', 'btm_sample')

        # Deleting field 'Sample.vote_sample'
        db.delete_column('main_sample', 'vote_sample')
