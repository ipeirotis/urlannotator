...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.activated'
        db.add_column('main_job', 'activated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 8, 2, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.activated'
        db.delete_column('main_job', 'activated')
    ...
    models = {
        ...
        'main.job': {
            ...
            'activated': ('django.db.models.fields.DateTimeField', [], {}),
