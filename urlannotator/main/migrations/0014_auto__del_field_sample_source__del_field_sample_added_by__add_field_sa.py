...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('main_sample', 'source')

        # Deleting field 'Sample.added_by'
        db.delete_column('main_sample', 'added_by_id')

        # Adding field 'Sample.source_type'
        db.add_column('main_sample', 'source_type',
                      self.gf('django.db.models.fields.CharField')(default='1', max_length=100),
                      keep_default=False)

        # Deleting field 'Worker.first_name'
        db.delete_column('main_worker', 'first_name')

        # Deleting field 'Worker.last_name'
        db.delete_column('main_worker', 'last_name')


    def backwards(self, orm):
        # Adding field 'Sample.source'
        db.add_column('main_sample', 'source',
                      self.gf('django.db.models.fields.CharField')(default='gold', max_length=100),
                      keep_default=False)

        # Adding field 'Sample.added_by'
        db.add_column('main_sample', 'added_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['main.Worker']),
                      keep_default=False)

        # Deleting field 'Sample.source_type'
        db.delete_column('main_sample', 'source_type')

        # Adding field 'Worker.first_name'
        db.add_column('main_worker', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=30),
                      keep_default=False)

        # Adding field 'Worker.last_name'
        db.add_column('main_worker', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='test', max_length=30),
                      keep_default=False)
