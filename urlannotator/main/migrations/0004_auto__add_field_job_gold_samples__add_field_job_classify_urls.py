...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.gold_samples'
        db.add_column('main_job', 'gold_samples',
                      self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True),
                      keep_default=False)

        # Adding field 'Job.classify_urls'
        db.add_column('main_job', 'classify_urls',
                      self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.gold_samples'
        db.delete_column('main_job', 'gold_samples')

        # Deleting field 'Job.classify_urls'
        db.delete_column('main_job', 'classify_urls')
