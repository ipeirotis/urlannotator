...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.btm_status'
        db.add_column('main_job', 'btm_status',
                      self.gf('django.db.models.fields.CharField')(default='not_active', max_length=50),
                      keep_default=False)

        # Adding field 'Job.btm_title'
        db.add_column('main_job', 'btm_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250),
                      keep_default=False)

        # Adding field 'Job.btm_description'
        db.add_column('main_job', 'btm_description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.btm_status'
        db.delete_column('main_job', 'btm_status')

        # Deleting field 'Job.btm_title'
        db.delete_column('main_job', 'btm_title')

        # Deleting field 'Job.btm_description'
        db.delete_column('main_job', 'btm_description')
