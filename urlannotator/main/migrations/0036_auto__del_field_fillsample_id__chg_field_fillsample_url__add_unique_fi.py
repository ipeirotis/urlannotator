...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FillSample.id'
        db.delete_column('main_fillsample', 'id')
        ...
        # Adding unique constraint on 'FillSample', fields ['url']
        db.create_unique('main_fillsample', ['url'])


    def backwards(self, orm):
        # Removing unique constraint on 'FillSample', fields ['url']
        db.delete_unique('main_fillsample', ['url'])

        # Adding field 'FillSample.id'
        db.add_column('main_fillsample', 'id',
                      self.gf('django.db.models.fields.AutoField')(default='', primary_key=True),
                      keep_default=False)


        # Changing field 'FillSample.url'
        db.alter_column('main_fillsample', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
