...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sample.added_on'
        db.alter_column('main_sample', 'added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'Sample.added_on'
        db.alter_column('main_sample', 'added_on', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
