...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WorkerJobAssociation.data'
        db.add_column('main_workerjobassociation', 'data',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'WorkerJobAssociation.data'
        db.delete_column('main_workerjobassociation', 'data')
