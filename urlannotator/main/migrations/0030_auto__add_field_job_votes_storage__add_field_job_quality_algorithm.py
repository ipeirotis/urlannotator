...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.votes_storage'
        db.add_column('main_job', 'votes_storage',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)

        # Adding field 'Job.quality_algorithm'
        db.add_column('main_job', 'quality_algorithm',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.votes_storage'
        db.delete_column('main_job', 'votes_storage')

        # Deleting field 'Job.quality_algorithm'
        db.delete_column('main_job', 'quality_algorithm')
