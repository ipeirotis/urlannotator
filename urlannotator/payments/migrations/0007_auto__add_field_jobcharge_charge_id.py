...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCharge.charge_id'
        db.add_column('payments_jobcharge', 'charge_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCharge.charge_id'
        db.delete_column('payments_jobcharge', 'charge_id')
