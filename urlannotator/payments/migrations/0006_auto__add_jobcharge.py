...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JobCharge'
        db.create_table('payments_jobcharge', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'], null=True)),
            ('customer_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('payments', ['JobCharge'])


    def backwards(self, orm):
        # Deleting model 'JobCharge'
        db.delete_table('payments_jobcharge')
