...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BTMBonusPayment'
        db.create_table('payments_btmbonuspayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('worker', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Worker'])),
            ('points_covered', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('sub_status', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('additional_data', self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True)),
        ))
        db.send_create_signal('payments', ['BTMBonusPayment'])


    def backwards(self, orm):
        # Deleting model 'BTMBonusPayment'
        db.delete_table('payments_btmbonuspayment')
