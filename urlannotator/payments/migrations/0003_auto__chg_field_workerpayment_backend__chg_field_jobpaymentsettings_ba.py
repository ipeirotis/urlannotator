...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkerPayment.backend'
        db.alter_column('payments_workerpayment', 'backend', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'JobPaymentSettings.backend'
        db.alter_column('payments_jobpaymentsettings', 'backend', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'WorkerPayment.backend'
        db.alter_column('payments_workerpayment', 'backend', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'JobPaymentSettings.backend'
        db.alter_column('payments_jobpaymentsettings', 'backend', self.gf('django.db.models.fields.CharField')(max_length=25))
