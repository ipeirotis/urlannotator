...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCharge.charge_type'
        db.add_column('payments_jobcharge', 'charge_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCharge.charge_type'
        db.delete_column('payments_jobcharge', 'charge_type')
