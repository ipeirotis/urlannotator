...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobCharge.amount'
        db.add_column('payments_jobcharge', 'amount',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'JobCharge.currency'
        db.add_column('payments_jobcharge', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobCharge.amount'
        db.delete_column('payments_jobcharge', 'amount')

        # Deleting field 'JobCharge.currency'
        db.delete_column('payments_jobcharge', 'currency')
    ...
    models = {
        ...
        'payments.jobcharge': {
            'Meta': {'object_name': 'JobCharge'},
            'amount': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'charge_id': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'charge_type': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
