...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobPaymentSettings.backend_params'
        db.add_column('payments_jobpaymentsettings', 'backend_params',
                      self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'JobPaymentSettings.backend_params'
        db.delete_column('payments_jobpaymentsettings', 'backend_params')
