...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClassifierPerformance.value'
        db.alter_column('classification_classifierperformance', 'value', self.gf('tenclouds.django.jsonfield.fields.JSONField')({}))

    def backwards(self, orm):

        # Changing field 'ClassifierPerformance.value'
        db.alter_column('classification_classifierperformance', 'value', self.gf('django.db.models.fields.IntegerField')())
