...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ClassifiedSample.url'
        db.alter_column('classification_classifiedsample', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'ClassifiedSample.url'
        db.alter_column('classification_classifiedsample', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
    ...
    models = {
        ...
        'classification.trainingsample': {
            'Meta': {'unique_together': "(['set', 'sample'],)", 'object_name': 'TrainingSample'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
