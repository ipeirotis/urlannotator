...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TrainingSample', fields ['sample', 'set']
        db.create_unique('classification_trainingsample', ['sample_id', 'set_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TrainingSample', fields ['sample', 'set']
        db.delete_unique('classification_trainingsample', ['sample_id', 'set_id'])
