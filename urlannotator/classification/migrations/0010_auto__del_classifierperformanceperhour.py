...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ClassifierPerformancePerHour'
        db.delete_table('classification_classifierperformanceperhour')


    def backwards(self, orm):
        # Adding model 'ClassifierPerformancePerHour'
        db.create_table('classification_classifierperformanceperhour', (
            ...
            ('value', self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True)),
        ))
        db.send_create_signal('classification', ['ClassifierPerformancePerHour'])
