...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Classifier.type'
        db.alter_column('classification_classifier', 'type', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Classifier.type'
        db.alter_column('classification_classifier', 'type', self.gf('django.db.models.fields.CharField')(max_length=20))
