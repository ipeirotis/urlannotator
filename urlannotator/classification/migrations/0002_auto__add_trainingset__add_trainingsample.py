...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('classification_trainingset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'])),
            ('revision', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('classification', ['TrainingSet'])

        # Adding model 'TrainingSample'
        db.create_table('classification_trainingsample', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(related_name='training_samples', to=orm['main.Job'])),
        ...
        db.send_create_signal('classification', ['TrainingSample'])


    def backwards(self, orm):
        # Deleting model 'TrainingSet'
        db.delete_table('classification_trainingset')

        # Deleting model 'TrainingSample'
        db.delete_table('classification_trainingsample')
    ...
    models = {
        ...
        'classification.trainingsample': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'training_samples'", 'to': "orm['main.Job']"}),
