...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClassifierPerformancePerHour.delta'
        db.delete_column('classification_classifierperformanceperhour', 'delta')


        # Changing field 'ClassifierPerformancePerHour.value'
        db.alter_column('classification_classifierperformanceperhour', 'value', self.gf('tenclouds.django.jsonfield.fields.JSONField')({}))

    def backwards(self, orm):
        # Adding field 'ClassifierPerformancePerHour.delta'
        db.add_column('classification_classifierperformanceperhour', 'delta',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'ClassifierPerformancePerHour.value'
        db.alter_column('classification_classifierperformanceperhour', 'value', self.gf('django.db.models.fields.IntegerField')())
