...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClassifiedSample.added_on'
        db.add_column('classification_classifiedsample', 'added_on',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 11, 9, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClassifiedSample.added_on'
        db.delete_column('classification_classifiedsample', 'added_on')
