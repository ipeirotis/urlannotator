...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'TrainingStatistics'
        db.delete_table('classification_trainingstatistics')

        # Adding model 'ClassifierPerformance'
        db.create_table('classification_classifierperformance', (
            ('statistics_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['classification.Statistics'], unique=True, primary_key=True)),
        ...
        db.send_create_signal('classification', ['ClassifierPerformance'])


    def backwards(self, orm):
        # Adding model 'TrainingStatistics'
        db.create_table('classification_trainingstatistics', (
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('job', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('classification', ['TrainingStatistics'])

        # Deleting model 'ClassifierPerformance'
        db.delete_table('classification_classifierperformance')
