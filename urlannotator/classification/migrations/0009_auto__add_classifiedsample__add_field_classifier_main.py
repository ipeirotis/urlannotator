...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClassifiedSample'
        db.create_table('classification_classifiedsample', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Sample'], null=True, blank=True)),
            ...
            ('source_val', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('label_probability', self.gf('tenclouds.django.jsonfield.fields.JSONField')({}, blank=True)),
        ))
        db.send_create_signal('classification', ['ClassifiedSample'])

        # Adding field 'Classifier.main'
        db.add_column('classification_classifier', 'main',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ClassifiedSample'
        db.delete_table('classification_classifiedsample')

        # Deleting field 'Classifier.main'
        db.delete_column('classification_classifier', 'main')
    ...
    models = {
        ...
        'classification.classifierperformance': {
            'Meta': {'object_name': 'ClassifierPerformance', '_ormbases': ['classification.Statistics']},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']"}),
            'statistics_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['classification.Statistics']", 'unique': 'True', 'primary_key': 'True'}),
            'value': ('tenclouds.django.jsonfield.fields.JSONField', ['{}'], {'blank': 'True'})
        },
        'classification.classifierperformanceperhour': {
            'Meta': {'object_name': 'ClassifierPerformancePerHour', '_ormbases': ['classification.Statistics']},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']"}),
            'statistics_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['classification.Statistics']", 'unique': 'True', 'primary_key': 'True'}),
            'value': ('tenclouds.django.jsonfield.fields.JSONField', ['{}'], {'blank': 'True'})
        ...
        'classification.trainingsample': {
            'Meta': {'object_name': 'TrainingSample'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'sample': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Sample']"}),
            'set': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'training_samples'", 'to': "orm['classification.TrainingSet']"})
        },
        'classification.trainingset': {
            'Meta': {'object_name': 'TrainingSet'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']"}),
            'revision': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
