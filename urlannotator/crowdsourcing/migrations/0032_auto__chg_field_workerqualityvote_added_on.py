...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WorkerQualityVote.added_on'
        db.alter_column('crowdsourcing_workerqualityvote', 'added_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'WorkerQualityVote.added_on'
        db.alter_column('crowdsourcing_workerqualityvote', 'added_on', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        'crowdsourcing.beatthemachinesample': {
            ...
            'points_change': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
