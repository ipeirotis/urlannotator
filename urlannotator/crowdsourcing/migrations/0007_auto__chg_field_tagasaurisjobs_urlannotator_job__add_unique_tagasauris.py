...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TagasaurisJobs.urlannotator_job'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Job'], unique=True))
        # Adding unique constraint on 'TagasaurisJobs', fields ['urlannotator_job']
        db.create_unique('crowdsourcing_tagasaurisjobs', ['urlannotator_job_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TagasaurisJobs', fields ['urlannotator_job']
        db.delete_unique('crowdsourcing_tagasaurisjobs', ['urlannotator_job_id'])


        # Changing field 'TagasaurisJobs.urlannotator_job'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job']))
    ...
    models = {
        ...
        'crowdsourcing.tagasaurisjobs': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sample_gatering_hit': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'sample_gatering_key': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
            ...
            'voting_key': ('django.db.models.fields.CharField', [], {'max_length': '25'})
        },
