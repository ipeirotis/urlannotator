...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TagasaurisJobs.sample_gatering_key'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'sample_gatering_key')

        # Adding field 'TagasaurisJobs.sample_gathering_key'
        db.add_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_key',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TagasaurisJobs.sample_gatering_key'
        db.add_column('crowdsourcing_tagasaurisjobs', 'sample_gatering_key',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Deleting field 'TagasaurisJobs.sample_gathering_key'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_key')
