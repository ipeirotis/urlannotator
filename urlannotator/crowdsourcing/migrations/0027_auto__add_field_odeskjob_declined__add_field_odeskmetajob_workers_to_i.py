...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OdeskJob.declined'
        db.add_column('crowdsourcing_odeskjob', 'declined',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'OdeskMetaJob.workers_to_invite'
        db.add_column('crowdsourcing_odeskmetajob', 'workers_to_invite',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OdeskJob.declined'
        db.delete_column('crowdsourcing_odeskjob', 'declined')

        # Deleting field 'OdeskMetaJob.workers_to_invite'
        db.delete_column('crowdsourcing_odeskmetajob', 'workers_to_invite')
