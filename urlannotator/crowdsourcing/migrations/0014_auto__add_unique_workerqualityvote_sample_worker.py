...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'WorkerQualityVote', fields ['sample', 'worker']
        db.create_unique('crowdsourcing_workerqualityvote', ['sample_id', 'worker_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'WorkerQualityVote', fields ['sample', 'worker']
        db.delete_unique('crowdsourcing_workerqualityvote', ['sample_id', 'worker_id'])
