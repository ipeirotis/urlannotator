...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BeatTheMachineSample'
        db.create_table('crowdsourcing_beatthemachinesample', (
            ...
            ('btm_status', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('crowdsourcing', ['BeatTheMachineSample'])


    def backwards(self, orm):
        # Deleting model 'BeatTheMachineSample'
        db.delete_table('crowdsourcing_beatthemachinesample')
