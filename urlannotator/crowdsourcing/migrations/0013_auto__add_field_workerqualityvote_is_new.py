...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkerQualityVote.is_new'
        db.add_column('crowdsourcing_workerqualityvote', 'is_new',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkerQualityVote.is_new'
        db.delete_column('crowdsourcing_workerqualityvote', 'is_new')
