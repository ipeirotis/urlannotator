...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OdeskMetaJob.hit_reference'
        db.add_column('crowdsourcing_odeskmetajob', 'hit_reference',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OdeskMetaJob.hit_reference'
        db.delete_column('crowdsourcing_odeskmetajob', 'hit_reference')
