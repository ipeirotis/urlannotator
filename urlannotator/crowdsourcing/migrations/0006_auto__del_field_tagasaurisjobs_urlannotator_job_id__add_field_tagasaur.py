...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TagasaurisJobs.urlannotator_job_id'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job_id')

        # Adding field 'TagasaurisJobs.urlannotator_job'
        db.add_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Job']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TagasaurisJobs.urlannotator_job_id'
        db.add_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job_id',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=25),
                      keep_default=False)

        # Deleting field 'TagasaurisJobs.urlannotator_job'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'urlannotator_job_id')
    ...
    models = {
        ...
        'crowdsourcing.tagasaurisjobs': {
            ...
            'urlannotator_job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']"}),
