...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SampleMapping'
        db.create_table('crowdsourcing_samplemapping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Sample'])),
            ('external_id', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('crowscourcing_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('crowdsourcing', ['SampleMapping'])

        # Adding field 'WorkerQualityVote.is_valid'
        db.add_column('crowdsourcing_workerqualityvote', 'is_valid',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'SampleMapping'
        db.delete_table('crowdsourcing_samplemapping')

        # Deleting field 'WorkerQualityVote.is_valid'
        db.delete_column('crowdsourcing_workerqualityvote', 'is_valid')
