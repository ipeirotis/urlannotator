...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OdeskJob.job'
        db.delete_column('crowdsourcing_odeskjob', 'job_id')

        # Adding field 'OdeskMetaJob.account'
        db.add_column('crowdsourcing_odeskmetajob', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Account']),
                      keep_default=False)


        # Changing field 'OdeskMetaJob.job'
        db.alter_column('crowdsourcing_odeskmetajob', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Job'], null=True))

    def backwards(self, orm):
        # Adding field 'OdeskJob.job'
        db.add_column('crowdsourcing_odeskjob', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Job']),
                      keep_default=False)

        # Deleting field 'OdeskMetaJob.account'
        db.delete_column('crowdsourcing_odeskmetajob', 'account_id')


        # Changing field 'OdeskMetaJob.job'
        db.alter_column('crowdsourcing_odeskmetajob', 'job_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.Job']))
