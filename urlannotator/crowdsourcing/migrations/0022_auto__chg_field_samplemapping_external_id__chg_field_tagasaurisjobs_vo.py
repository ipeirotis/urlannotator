...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SampleMapping.external_id'
        db.alter_column('crowdsourcing_samplemapping', 'external_id', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'TagasaurisJobs.voting_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_hit', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_hit', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_key', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'TagasaurisJobs.voting_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_hit', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_key', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_hit', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'SampleMapping.external_id'
        db.alter_column('crowdsourcing_samplemapping', 'external_id', self.gf('django.db.models.fields.CharField')(max_length=25))
