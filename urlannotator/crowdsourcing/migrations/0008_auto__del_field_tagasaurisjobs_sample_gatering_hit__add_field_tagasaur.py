...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TagasaurisJobs.sample_gathering_hit'
        db.add_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_hit',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TagasaurisJobs.sample_gathering_hit'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_hit')
