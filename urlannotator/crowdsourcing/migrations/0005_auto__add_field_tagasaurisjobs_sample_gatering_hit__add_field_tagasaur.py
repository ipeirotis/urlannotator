...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TagasaurisJobs.sample_gatering_hit'
        db.add_column('crowdsourcing_tagasaurisjobs', 'sample_gatering_hit',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TagasaurisJobs.voting_hit'
        db.add_column('crowdsourcing_tagasaurisjobs', 'voting_hit',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TagasaurisJobs.sample_gatering_hit'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'sample_gatering_hit')

        # Deleting field 'TagasaurisJobs.voting_hit'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'voting_hit')
    ...
    models = {
        ...
        'crowdsourcing.tagasaurisjobs': {
            ...
            'urlannotator_job_id': ('django.db.models.fields.CharField', [], {'max_length': '25'}),
