...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkerQualityVote.btm_vote'
        db.add_column('crowdsourcing_workerqualityvote', 'btm_vote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TagasaurisJobs.voting_btm_key'
        db.add_column('crowdsourcing_tagasaurisjobs', 'voting_btm_key',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)

        # Adding field 'TagasaurisJobs.voting_btm_hit'
        db.add_column('crowdsourcing_tagasaurisjobs', 'voting_btm_hit',
                      self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkerQualityVote.btm_vote'
        db.delete_column('crowdsourcing_workerqualityvote', 'btm_vote')

        # Deleting field 'TagasaurisJobs.voting_btm_key'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'voting_btm_key')

        # Deleting field 'TagasaurisJobs.voting_btm_hit'
        db.delete_column('crowdsourcing_tagasaurisjobs', 'voting_btm_hit')
    ...
    models = {
        ...
        'crowdsourcing.tagasaurisjobs': {
            ...
            'voting_btm_hit': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
            'voting_btm_key': ('django.db.models.fields.CharField', [], {'max_length': '25', 'null': 'True', 'blank': 'True'}),
