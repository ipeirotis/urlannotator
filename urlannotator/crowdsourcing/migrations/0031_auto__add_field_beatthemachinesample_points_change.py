...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeatTheMachineSample.points_change'
        db.add_column('crowdsourcing_beatthemachinesample', 'points_change',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeatTheMachineSample.points_change'
        db.delete_column('crowdsourcing_beatthemachinesample', 'points_change')
