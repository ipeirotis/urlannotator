...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagasaurisJobs'
        db.create_table('crowdsourcing_tagasaurisjobs', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sample_gatering_key', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('voting_key', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('beatthemachine_key', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
        ))
        db.send_create_signal('crowdsourcing', ['TagasaurisJobs'])


    def backwards(self, orm):
        # Deleting model 'TagasaurisJobs'
        db.delete_table('crowdsourcing_tagasaurisjobs')
