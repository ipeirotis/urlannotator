...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BeatTheMachineSample.url'
        db.alter_column('crowdsourcing_beatthemachinesample', 'url', self.gf('django.db.models.fields.URLField')(max_length=500))

        # Changing field 'TagasaurisJobs.voting_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_key', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_key', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_hit', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_hit', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_key', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'TagasaurisJobs.voting_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_hit', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_key', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_hit', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'BeatTheMachineSample.url'
        db.alter_column('crowdsourcing_beatthemachinesample', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'TagasaurisJobs.voting_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_key', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_key', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_hit', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_hit', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.sample_gathering_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'sample_gathering_key', self.gf('django.db.models.fields.CharField')(max_length=25))

        # Changing field 'TagasaurisJobs.voting_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_hit', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.beatthemachine_key'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'beatthemachine_key', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'TagasaurisJobs.voting_btm_hit'
        db.alter_column('crowdsourcing_tagasaurisjobs', 'voting_btm_hit', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))
    ...
    models = {
        ...
        'crowdsourcing.tagasaurisjobs': {
            ...
            'beatthemachine_hit': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'beatthemachine_key': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sample_gathering_hit': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'sample_gathering_key': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'urlannotator_job': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['main.Job']", 'unique': 'True'}),
            'voting_btm_hit': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'voting_btm_key': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'voting_hit': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'voting_key': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
