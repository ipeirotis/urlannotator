...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TroiaJob'
        db.create_table('crowdsourcing_troiajob', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('job', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['main.Job'], unique=True)),
            ('troia_id', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('crowdsourcing', ['TroiaJob'])


    def backwards(self, orm):
        # Deleting model 'TroiaJob'
        db.delete_table('crowdsourcing_troiajob')
